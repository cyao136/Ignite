...
* Clone the repo: 'git clone git@gitlab.com:cyao136/web-client.git'
...
* Start faye in another window: 'rackup faye -s thin -E production'
* Start the daemons for job processing: 'RAILS_ENV=production bin/delayed_job start' (for linux)
